...
var _17=_d.frame=_17=doc.createElement(dojo.isIE?"<iframe src=\"init_src.html\" name=\""+_10+"\" onload=\"dojox.io.windowName["+_e+"]()\">":"iframe");
styleFrame(_17);
...
try{
if(_17.contentWindow.location=="about:blank"){
return;
}
}
catch(e){
